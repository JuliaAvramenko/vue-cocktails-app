    ...
    <AppLayout imgUrl='~@/assets/img/bg-1.jpg' :backFunc="removeIngredient" :is-back-button-visible="!!ingredient">
        <div class="wrapper">
            <div v-if="!ingredient || !cocktails" class="info">
                ...
                <div class="text">Try our delicious cocktail recipies for every occasion. Find delicious cocktail
                    recipies by ingredient through our coctail generator.</div>
            </div>
            <!-- <img src='/src/assets/img/coctails.png' alt='Cocktails' class="img"> -->
